        ...
        http
                .authorizeHttpRequests(authorizeRequests ->
                        authorizeRequests
                                ...
                                .requestMatchers("/api/auth/programs").authenticated() // Public endpoints for registration and login
                                .requestMatchers("/api/auth/programsById/{id}").authenticated() // Public endpoints for registration and login
